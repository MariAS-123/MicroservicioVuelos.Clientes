...
namespace Microservicio.Clientes.DataManagement.UnitOfWork;

public class UnitOfWork : IUnitOfWork
{
    // ✅ Cambiado al contexto del MS Clientes
    private readonly SistemaVuelosClientesDBContext _context;
    private IDbContextTransaction? _currentTransaction;

    public UnitOfWork(SistemaVuelosClientesDBContext context)
    {
        _context = context;
    }
